...
| [resources.md](./resources.md) | Fiedler's series, Godot networking docs, RFC 768, Wikipedia primers, free packet inspection tools |
| [lecture-notes/01-networking-models-latency-and-udp.md](./lecture-notes/01-networking-models-latency-and-udp.md) | The three models; the latency budget; UDP vs TCP; sockets at the byte level; RFC 768 |
| [lecture-notes/02-snapshots-interpolation-prediction-reconciliation.md](./lecture-notes/02-snapshots-interpolation-prediction-reconciliation.md) | The snapshot loop; jitter buffer; client-side prediction; server reconciliation; state vs events |
| [lecture-notes/03-godot-multiplayer-api-and-the-rpc-pattern.md](./lecture-notes/03-godot-multiplayer-api-and-the-rpc-pattern.md) | MultiplayerAPI, ENet, @rpc, MultiplayerSpawner, MultiplayerSynchronizer, hosting realities |
| [exercises/exercise-01-udp-echo.py](./exercises/exercise-01-udp-echo.py) | A raw `socket.SOCK_DGRAM` echo client + server in one file, with a moving-average RTT meter |
| [exercises/exercise-02-snapshot-loop.py](./exercises/exercise-02-snapshot-loop.py) | A 20 Hz server snapshot loop and a client jitter-buffered interpolator, headless |
| [exercises/exercise-03-two-cursors-pygame.py](./exercises/exercise-03-two-cursors-pygame.py) | The capstone exercise: two Pygame clients see each other's mouse cursor on a shared canvas |
| [exercises/exercise-04-godot-cursor-rpc.gd](./exercises/exercise-04-godot-cursor-rpc.gd) | The Godot 4.x port: an `@rpc` cursor-position broadcaster (read-only reference, with a setup README) |
| [exercises/SOLUTIONS.md](./exercises/SOLUTIONS.md) | Solution discussion and the "common bugs" list for each exercise |
| [challenges/challenge-01-measure-your-link.md](./challenges/challenge-01-measure-your-link.md) | A measurement exercise: `ping`, `traceroute`, packet capture, and a written RTT-distribution report |
| [challenges/challenge-02-design-a-rollback-netcode-sketch.md](./challenges/challenge-02-design-a-rollback-netcode-sketch.md) | A paper-design exercise: sketch a rollback netcode design for a two-player fighting game |
| [quiz.md](./quiz.md) | Ten multiple-choice questions |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | The two-cursor shared canvas with an authoritative server, jitter buffer, and a 20-second demo |
| [mini-project/starter_server.py](./mini-project/starter_server.py) | The authoritative server scaffold: bind socket, accept HELLO, broadcast snapshots at 20 Hz |
| [mini-project/starter_client.py](./mini-project/starter_client.py) | The Pygame client scaffold: connect, send mouse, interpolate the cursor list, render |
