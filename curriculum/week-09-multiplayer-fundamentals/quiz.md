...
**B.** Client-server authoritative. (Lecture 1 §1.1)
...
**B.** Head-of-line blocking. (Lecture 1 §3.2)
...
**C.** ~300 ms RTT. (Lecture 1 §2 table — 150-200 is "tolerable for non-twitch," 200-300 is "tolerable for turn-based," above 300 is "wrong.")
...
**B.** 8 bytes. (Lecture 1 §4 — four 16-bit fields.)
...
**B.** To always have two received snapshots bracketing the render time. (Lecture 2 §1.2)
...
**B.** Several snapshot periods plus margin. (Lecture 2 §2.1)
...
**B.** State tolerates loss; events do not. (Lecture 2 §3)
...
**B.** Rewind and re-apply inputs. (Lecture 2 §5)
...
**B.** Any peer can call; runs locally on sender too; sent unreliably. (Lecture 3 §3)
...
**A.** Spawner replicates node creation; Synchronizer replicates node properties. (Lecture 3 §4-5)
