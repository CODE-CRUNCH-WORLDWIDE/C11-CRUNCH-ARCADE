...
The shader part of game programming is the area learners tend to either *love* or *fear*. The fear comes from the unfamiliar mental model: parallel evaluation, no I/O, no print statements. The love comes from the speed of iteration: change one number, save, see the result. Both reactions are normal. By the end of this homework, the fear should be smaller.
