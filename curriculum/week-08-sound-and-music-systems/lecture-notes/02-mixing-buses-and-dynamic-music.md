...
*The larger bus tree, showing how every leaf's effective volume is the product down the chain from master.*
...
stateDiagram-v2
  [*] --> Idle
  Idle --> FadingDown: begin_duck
  FadingDown --> Ducked: fade complete
  Ducked --> FadingUp: end_duck
  FadingUp --> Idle: fade complete
```

*The duck volume state machine, driven by dialogue start and the DIALOGUE_END_EVENT.*
