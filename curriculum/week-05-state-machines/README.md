...
| [resources.md](./resources.md) | Nystrom's State chapter, Valve's animation talks, the AI Game Programming Wisdom FSM essays |
| [lecture-notes/01-hand-rolled-fsm.md](./lecture-notes/01-hand-rolled-fsm.md) | What an FSM *is*; the `Enum`+dict version; the four-phase update; explicit transitions |
| [lecture-notes/02-state-transitions-and-substates.md](./lecture-notes/02-state-transitions-and-substates.md) | The State pattern; lifecycle hooks; substates; the state stack; animation-event hooks |
| [exercises/README.md](./exercises/README.md) | Index of short coding drills |
| [exercises/exercise-01-fsm-from-nested-ifs.py](./exercises/exercise-01-fsm-from-nested-ifs.py) | Take a 60-line tangle of nested ifs and refactor it into a 5-state hand-rolled FSM |
| [exercises/exercise-02-character-with-states.py](./exercises/exercise-02-character-with-states.py) | Build a four-state character (`idle`/`run`/`jump`/`fall`) using one class per state |
| [exercises/exercise-03-state-stack.py](./exercises/exercise-03-state-stack.py) | A pushdown automaton: pause the gameplay state, push a "paused" overlay, resume cleanly |
| [challenges/README.md](./challenges/README.md) | Index of weekly challenges |
| [challenges/challenge-01-enemy-ai-fsm.md](./challenges/challenge-01-enemy-ai-fsm.md) | A patrolling enemy with `patrol`/`chase`/`attack`/`return` states |
| [quiz.md](./quiz.md) | 10 multiple-choice questions |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | A player character with at least four states and clean transitions |
