...
- The single trickiest format to implement, and why. (Most learners answer: the integer encoders, because there are seven different integer formats and you have to pick the smallest one that fits.)
...
- The recommendation you would make to a future learner who has to decide between (a) shipping your pure-GDScript MessagePack and (b) shipping JSON. The right answer is "JSON, unless you have measured save throughput as a problem"; the wrong answer is "always MessagePack."
