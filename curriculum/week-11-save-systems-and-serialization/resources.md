...
For the learner who has the week to spend, the recommended reading order is:
...
For the learner short on time, the irreducible minimum is the Godot saving-games tutorial and the three lecture notes in this folder. The rest is enrichment.
